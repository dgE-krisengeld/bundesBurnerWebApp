    ...
    return (
        <div>
            ...
            {sending && <div
                ...
                <div style={{marginTop: 200, textAlign: "center", color: '#FFF'}}>Geld wird gesendet. Bitte warten.</div>
            </div>
            }
            ...
            <FormControl fullWidth>
                <TextField id="notiz" label="Notiz (optional)" type="search" onChange={(event)=> {setNote(event.target.value)}} value={note}/>
            </FormControl>

            <div style={{position: "absolute",
                bottom: 80, flex: 1, left: -10, right: -10, padding: "0 40px", display: "flex", justifyContent: "space-between", zIndex: 1}}>
                <Button variant="contained" onClick={() => onSubmit({recipient, amount, note})} style={{width: "100%"}} color="primary">Zahlen</Button>
